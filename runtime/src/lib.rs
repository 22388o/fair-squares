...
use sp_core::{crypto::KeyTypeId, u32_trait::{_1, _2, _3, _5}, OpaqueMetadata};
use sp_runtime::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("node-fs"),
	impl_name: create_runtime_str!("node-fs"),
	authoring_version: 1,
...
impl pallet_fs::Config for Runtime {
	type Event = Event;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		// Include the custom logic from the pallet-fs in the runtime.
...
impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn benchmark_metadata(extra: bool) -> (
			...
			list_benchmark!(list, extra, pallet_fs, FsModule);
		...
		fn dispatch_benchmark(
			...
			add_benchmark!(params, batches, pallet_fs, FsModule);
